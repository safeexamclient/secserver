            ...
            <form method="post" name="form1" id="form1" action="/user/signup_do">
                <table border="0" width="500px" style="min-height: 300px">
                  ...
                  <tr>
                    <td>联系人手机：</td>
                    <td>
                      <input type="text" id="user_mobile" name="user_mobile" value="" style="width: 240px;" maxlength="11" placeholder="示例：13900010002"> <span style="color:red;">*</span> </td>
                  </tr>
                  <tr>
                    <td>联系人邮箱：</td>
                    <td>
                      <input type="text" id="user_email" name="user_email" value="" style="width: 240px;" maxlength="50" placeholder="示例：user@domain.com"> <span style="color:red;">*</span> </td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td>
