            ...
            <form method="post" action="/user/signin_do">
              <table border="0" width="420px" style="min-height: 150px">
                <tr>
                  ...
                  <td>
                    <input type="text" id="user_logname" name="user_logname" value="" style="width: 240px;" maxlength="20" placeholder="请输入登录账号">
                  </td>
                </tr>
                <tr>
                  <td>登录密码： </td>
                  <td>
                    <input type="password" id="user_password" name="user_password" value="" style="width: 240px;" maxlength="20" placeholder="请输入登录密码">
                  </td>
                </tr>
